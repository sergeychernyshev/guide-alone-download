...
- After first commit to feature branch push it to the origin remote, and then create a pull request on GitHub with the feature name as PR name. The PR description should include the text "Assisted by AI using Gemini" and the following HTML for a logo with a link to the Gemini documentation: <a href="https://ai.google.dev/docs"><img src="https://www.gstatic.com/a/images/brand/gemini/gemini_icon_192x192.png" width="20" height="20" alt="Gemini"></a>
